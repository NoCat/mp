...
namespace mp.BLL
{
    public class FileManager:ManagerBase<DAL.File>
    {
        public FileManager(MiaopassContext db, ManagerCollection collection) : base(db, collection) { }

        public mp.DAL.File Add(Stream s)
        {
            s.Position = 0;
            var md5 = s.MD5();
